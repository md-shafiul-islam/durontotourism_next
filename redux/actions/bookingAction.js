...
import { EX_BOOKING_URL, GET_ERRORS, GET_ROUND_TRIP_BOOKING, REQUEST_HEADER } from "../types";
...
export const getRoundTripBookingAction = (query)=> async(dispatch)=>{
    ...
    console.log("BOOKING Result, ", result&&result.data&&JSON.stringify(result.data.request, null, 2));
