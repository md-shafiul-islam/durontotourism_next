...
const ProfileHeader = ({ title, imageUrl = undefined, tagLine, imgAlt }) => {
  return (
    <React.Fragment>
            ...
            <div className="header-right-content">
              {imageUrl !== undefined ? (
                <div className="image-area">
                  <CstImageView src={imageUrl} altTag={imgAlt} width={500} height={500} />
                </div>
              ) : (
                ""
              )}
              ...
              <div className="edt-btn-area">
                <button className="edt-btn" /** onClick={editProfileAction} */>
                  Edit
                </button>
              </div>
            </div>
